...
# generation configs
num_samples = 5
prompt = "The cat and the dog are playing by the seaside, with the cat's paw stroking the dog's head., clear layout (dog left, cat right), detailed fur, vibrant beach scenery, high resolution, clear layout (dog left, cat right), detailed fur, vibrant beach scenery, high resolution, clear layout (dog left, cat right), detailed fur, vibrant beach scenery, high resolution, clear layout (dog left, cat right), detailed fur, vibrant beach scenery, high resolution"
